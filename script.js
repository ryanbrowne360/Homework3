...
function generatePassword() {
  ...
  console.log(userinput.Scharacters) 
  console.log(userinput.UppercaseC)
  console.log(userinput.LowercaseC)
  console.log(userinput.numeric)
  ...
  console.log(possiblecharacters) //0 , 1 , 2 , 3 , 4 , 5, 6, 7 ,8
  ...
  return guaranteedCharactors.join("")
}
